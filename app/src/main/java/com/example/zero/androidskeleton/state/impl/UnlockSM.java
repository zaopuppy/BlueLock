 ...
 */
public class UnlockSM extends StateMachine {
    private static final String TAG = "UnlockSM";
    ...
    public UnlockSM(android.content.Context context, BtLeDevice device) {
        mContext = context;
        mDevice = device;
        init(IDLE);
    }
        ...
        public void handle(Context context, int event, int arg, Object o) {
            switch (event) {
                ...
                case EVENT_UNLOCK:
                    ...
                    String phoneNum = Utils.getPhoneNum(mContext);
